    ...
    <section className="relative min-h-screen flex items-center">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 py-32">
        <div className="max-w-2xl animate-fade-in-up">
          <p className="text-xs tracking-[0.3em] uppercase font-sans text-muted-foreground mb-6">
            Urban Skin Recovery
          </p>
          ...
          <p className="font-sans text-base md:text-lg text-muted-foreground max-w-md mb-10 leading-relaxed">

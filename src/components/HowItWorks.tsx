...
const steps = [
  {
    ...
    description:
      "Shield your skin from PM2.5 particles, blue light, and environmental aggressors with our Urban Shield Complex™.",
    product: products[0],
  },
  {
    number: "02",
    ...
    description:
      "Neutralize free radical damage from screens and deliver concentrated actives deep into the skin barrier overnight.",
    product: products[1],
  },
  {
    number: "03",
    ...
    description:
      "Lock in hydration and rebuild your skin's natural defense system with cold-pressed botanical oils while you sleep.",
    product: products[2],
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
        ...
        <div className="grid md:grid-cols-3 gap-8 md:gap-12 lg:gap-16">
          {steps.map((step, i) => (
            ...
            >
              <p className="font-serif text-5xl md:text-6xl text-border mb-4 md:mb-6">
                {step.number}
              </p>
              <h3 className="font-serif text-xl md:text-2xl text-foreground mb-1">
                {step.title}
              </h3>
              <p className="text-[11px] tracking-[0.12em] uppercase font-sans text-primary mb-3 md:mb-4">
                {step.subtitle}
              </p>
